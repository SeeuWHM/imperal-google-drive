...
# as the redirect URI in the Google console — it derives from the app_id, so
# any earlier /v1/ext/doc-reader/... or /v1/ext/imperal-google-drive/... URI
# must be replaced). Same pattern as mail-client.
ext.oauth(
    "google",
